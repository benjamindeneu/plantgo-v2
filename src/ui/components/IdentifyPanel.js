...
export function IdentifyPanel() {
  ...
  wrap.innerHTML = `
    ...
    <label class="label-file" for="files">
      <svg aria-hidden="true" width="16" height="16" viewBox="0 0 16 16"><path fill="currentColor" d="M10.5 2a.5.5 0 0 1 .5.5V3h2a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h2v-.5a.5.5 0 0 1 .5-.5h6Z"/></svg>
      Add photos
    </label>
