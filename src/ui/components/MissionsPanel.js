...
export function MissionsPanel() {
  ...
  sec.innerHTML = `
    ...
    <div style="display:flex;gap:8px;justify-content:center;margin-bottom:8px">
      <button id="locate" class="secondary"><i class="fa-solid fa-location-dot" aria-hidden="true"></i> Get Location & Missions</button>
    </div>
  ...
  sec.querySelector("#locate").addEventListener("click", async () => {
    ...
    try {
      ...
      if (!data || !Array.isArray(data?.missions || data)) {
